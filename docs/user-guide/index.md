...
<div class="component_card_widget">
  ...
  <a class="icon_document" href="https://github.com/open-edge-platform/skills/blob/main/README.md">Readme</a>
</div>
hide_directive-->
...
For the current catalog of available skills, see the [Skills Index](https://github.com/open-edge-platform/skills/tree/main#open-edge-platform--agent-skills-index)
