...
DLSTREAMER_PIPELINE_SERVER_IMAGE=intel/dlstreamer-pipeline-server:2026.2.0-ubuntu24
...
# Image tag 2026.2.0-ubuntu24 is an intentional pin (never :latest).
docker run --rm --user root -e http_proxy -e https_proxy -e no_proxy \
  -v "$PWD:/opt/project" intel/dlstreamer:2026.2.0-ubuntu24 bash -c '
    cd /opt/project
...
3. **Pinned image tags** — list the concrete tags (e.g. DLSPS
   `2026.2.0-ubuntu24`, `grafana/grafana:11.5.4`, `bluenviron/mediamtx:1.20.0`,
